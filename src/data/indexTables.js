...
// Source: MAS B738 LTS 12BC162EY R3 (MX-series and MLM onward)
// Approved per ref. WB290517/ME/B738X R03, effective 01/07/2022
// Passenger weight: 77 kg (CAD 6805 standard)
...
export const CARGO_INDEX_737_800 = {
  ...
  HOLD4: [ // Source: MAS B738 LTS R3 (verified against 12BC/162EY LTS)
    { weight: [1, 47],     index: 0 },
    { weight: [48, 143],   index: 1 },
    { weight: [144, 238],  index: 2 },
    { weight: [239, 333],  index: 3 },
    { weight: [334, 429],  index: 4 },
    { weight: [430, 474],  index: 5 },
  ],
};
